    ...
    <>
      <section className="  mx-auto">
        <div className="relative overflow-hidden bg-white">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-10">
            ...
            <div className="max-w-full w-full ">
              <div className="lg:max-w-3xl max-w-xl w-full mx-auto  ">
                <div className=" lg:px-20 lg:py-10   py-5">
                    ...
                    <form className="w-full space-y-4" ngNativeValidate>
                      <div>
                        ...
                        <input
                          ...
                          id="name"
                          ngModel
                          className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-bl-2xl focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5     "
                      ...
                      <div className="sm:col-span-2">
                        ...
                        <textarea
                          ...
                          ngModel
                          rows="4"
                          className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-bl-2xl shadow-sm border border-gray-300 focus:ring-primary-500 focus:border-primary-500     "
                      ...
                      <div className="text-center ">
                        <button
                          type="submit"
                          className="py-3 px-5 text-center text-sm hover:bg-[#1B356F] hover:text-white bg-[#1B356F]   text-white rounded-bl-3xl  sm:w-fit  "
                        >
                          Send message
                        </button>
                      </div>
